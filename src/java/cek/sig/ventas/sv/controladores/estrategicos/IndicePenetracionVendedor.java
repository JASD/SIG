...
public class IndicePenetracionVendedor extends SelectorComposer<Component> {
    ...
    private static final String JASPER_PATH = "/WEB-INF/jaspers/indice_penetracion_vendedor.jasper";
    @Wire
    ...
    public void generarReporte() throws JRException, IOException {
        if (formatos.getSelectedIndex() == -1) {
            ...
            File report = File.createTempFile("IndicePenetracionVendedores", format);
