 ...
 */
@Controller
public class IndiceCoberturaVendedor extends SelectorComposer<Component> {

    private static final String JASPER_PATH = "/WEB-INF/jaspers/indice_cobertura_vendedor.jasper";
    @Wire
    ...
    @RequestMapping(value = "/indiceCoberturaVendedor")
    public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        //logger.info("Returning hello view");
        //PurchaseData pd = new PurchaseData();
        ModelAndView mv = new ModelAndView("reportesEstrategicos/indiceCoberturaVendedor");
    ...
    public void generarReporte() throws JRException, IOException {
        if (formatos.getSelectedIndex() == -1) {
            ...
            File report = File.createTempFile("IndiceCoberturaVendedores", format);
            JasperExporter.export(realPath, params, new JRBeanCollectionDataSource(ipvList),
                    format, report);
